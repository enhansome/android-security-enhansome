...
[![Link Liveness Checker](https://github.com/ashishb/android-security-awesome/actions/workflows/validate-links.yml/badge.svg)](https://github.com/ashishb/android-security-awesome/actions/workflows/validate-links.yml) ⭐ 9,705 | 🐛 0 | 🌐 Makefile | 📅 2026-09-22

[![Lint Shell scripts](https://github.com/ashishb/android-security-awesome/actions/workflows/lint-shell-script.yaml/badge.svg)](https://github.com/ashishb/android-security-awesome/actions/workflows/lint-shell-script.yaml) ⭐ 9,705 | 🐛 0 | 🌐 Makefile | 📅 2026-09-22
[![Lint Markdown](https://github.com/ashishb/android-security-awesome/actions/workflows/lint-markdown.yaml/badge.svg)](https://github.com/ashishb/android-security-awesome/actions/workflows/lint-markdown.yaml) ⭐ 9,705 | 🐛 0 | 🌐 Makefile | 📅 2026-09-22
[![Lint YAML](https://github.com/ashishb/android-security-awesome/actions/workflows/lint-yaml.yaml/badge.svg)](https://github.com/ashishb/android-security-awesome/actions/workflows/lint-yaml.yaml) ⭐ 9,705 | 🐛 0 | 🌐 Makefile | 📅 2026-09-22
[![Lint GitHub Actions](https://github.com/ashishb/android-security-awesome/actions/workflows/lint-github-actions.yaml/badge.svg)](https://github.com/ashishb/android-security-awesome/actions/workflows/lint-github-actions.yaml) ⭐ 9,705 | 🐛 0 | 🌐 Makefile | 📅 2026-09-22
...
2. [Detekt](https://github.com/detekt/detekt) ⭐ 7,065 | 🐛 197 | 🌐 Kotlin | 📅 2026-09-21 - Static code analysis for Kotlin
3. [APKLeaks](https://github.com/dwisiswant0/apkleaks) ⭐ 6,305 | 🐛 26 | 🌐 Python | 📅 2025-08-20 - Scanning APK file for URIs, endpoints & secrets.
4. [Quark-Engine](https://github.com/quark-engine/quark-engine) ⭐ 1,724 | 🐛 77 | 🌐 Python | 📅 2026-09-19 - An Obfuscation-Neglect Android Malware Scoring System
...
1. [Mobile-Security-Framework MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,807 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-22 - Mobile Security Framework is an intelligent, all-in-one open-source mobile application (Android/iOS) automated pen-testing framework capable of performing static, dynamic analysis, and web API testing.
2. [Drozer](https://github.com/mwrlabs/drozer) ⭐ 4,619 | 🐛 9 | 🌐 Python | 📅 2026-04-08
3. [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,090 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime
...
8. [Androl4b](https://github.com/sh4hin/Androl4b) ⭐ 1,171 | 🐛 5 | 📅 2023-05-31- A Virtual Machine for Assessing Android applications, Reverse Engineering and Malware Analysis
...
11. [Droidbox](https://github.com/pjlantz/droidbox) ⭐ 806 | 🐛 32 | 🌐 Python | 📅 2023-06-22
...
1. [Jadx](https://github.com/skylot/jadx) ⭐ 50,561 | 🐛 449 | 🌐 Java | 📅 2026-09-12
2. [Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,629 | 🐛 77 | 🌐 Java | 📅 2026-09-21 – really useful for compilation/decompilation (uses smali)
3. [Radare2](https://github.com/radare/radare2) ⭐ 24,846 | 🐛 824 | 🌐 C | 📅 2026-09-22
4. [Bytecode viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,653 | 🐛 103 | 🌐 Java | 📅 2026-07-17
5. [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,196 | 🐛 248 | 🌐 Java | 📅 2024-07-08 - Java decompiler
6. [MVT (Mobile Verification Toolkit)](https://github.com/mvt-project/mvt) ⭐ 13,711 | 🐛 54 | 🌐 Python | 📅 2026-09-21 - a collection of utilities to simplify and automate the process of gathering forensic traces helpful to identify a potential compromise of Android and iOS devices
...
9. [PhoneSploit-Pro](https://github.com/AzeemIdrisi/PhoneSploit-Pro) ⭐ 6,301 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - An all-in-one hacking tool to remotely exploit Android devices using ADB and Metasploit Framework to get a Meterpreter session.
10. [Androguard](https://github.com/androguard/androguard) ⭐ 6,280 | 🐛 45 | 🌐 Python | 📅 2026-09-22 – powerful, integrates well with other tools
...
13. [FernFlower](https://github.com/fesh0r/fernflower) ⭐ 4,404 | 🐛 0 | 🌐 Java | 📅 2026-09-22 - Java decompiler
14. [APKLab](https://github.com/APKLab/APKLab) ⭐ 3,991 | 🐛 24 | 🌐 TypeScript | 📅 2026-07-16 - plugin for VS Code to analyze APKs
15. [Enjarify](https://github.com/google/enjarify) ⚠️ Archived - dex to jar converter from Google
16. [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,253 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 - Java decompiler
...
1. [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,116 | 🐛 492 | 🌐 Python | 📅 2026-09-10
...
7. [ARMv7 payload that provides arbitrary code execution on MediaTek bootloaders](https://github.com/R0rt1z2/kaeru) ⭐ 309 | 🐛 18 | 🌐 C | 📅 2026-09-19
...
10. [Spectre](https://github.com/thomasbuilds/Spectre) ⭐ 170 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-22 - Radio frequency scanner with recon and offensive capabilities. Monitors cellular, Wi-Fi, Bluetooth LE, and GNSS on-device, with a BLE GATT inspector, iBeacon broadcaster, and local-network discovery.
...
4. [Oversecured Vulnerable Android App (OVAA)](https://github.com/oversecured/ovaa) ⭐ 758 | 🐛 2 | 🌐 Java | 📅 2024-07-18
...
1. [OWASP Mobile Security Testing Guide Manual](https://github.com/OWASP/owasp-mstg) ⭐ 13,192 | 🐛 240 | 🌐 Python | 📅 2026-09-20
