...
1. [QARK](https://github.com/linkedin/qark/) ⭐ 3,381 | 🐛 79 | 🌐 Python | 📅 2024-01-16 - QARK by LinkedIn is for app developers to scan apps for security issues
...
2. [Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,405 | 🐛 81 | 🌐 Java | 📅 2026-08-26 – really useful for compilation/decompilation (uses smali)
3. [Radare2](https://github.com/radare/radare2) ⭐ 24,674 | 🐛 827 | 🌐 C | 📅 2026-08-29
4. [Bytecode viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,618 | 🐛 103 | 🌐 Java | 📅 2026-07-17
...
14. [APKLab](https://github.com/APKLab/APKLab) ⭐ 3,952 | 🐛 24 | 🌐 TypeScript | 📅 2026-07-16 - plugin for VS Code to analyze APKs
...
1. [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,843 | 🐛 464 | 🌐 Python | 📅 2026-08-25
...
10. [Spectre](https://github.com/thomasbuilds/Spectre) ⭐ 149 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-28 - Radio frequency scanner with recon and offensive capabilities. Monitors cellular, Wi-Fi, Bluetooth LE, and GNSS on-device, with a BLE GATT inspector, iBeacon broadcaster, and local-network discovery.
...
1. [Android InsecureBank](https://github.com/dineshshetty/Android-InsecureBankv2) ⭐ 1,473 | 🐛 17 | 🌐 Java | 📅 2024-04-17
